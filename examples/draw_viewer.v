					...
					dv.drawviewer_canvaslayout(
						...
						shapes: [
							dv.plot(
								...
								shapes: [dv.curve(style: 'thick_line', f: math.sin),
									dv.scatterplot(x: runif(30, -3, 3), y: runif(30, -1,
										1), radius: 5)]
							),
							dv.path(
								style: 'thin_line'
							...
							dv.poly(
								points: [f32(0), 0, 100, 0, 150, 50, 110, 70, 80, 50, 40, 60, 0,
									10]
								offset_x: arx + 150
								offset_y: ary + 100 * 1.1
							),
							dv.poly(
								points: [f32(0), 0, 40, -40, 100, 0, 150, 50, 110, 70, 80, 50,
									40, 60, 0, 10, 20, 5, 40, -2, 70, 32, 32, 20]
								holes: [8]
								offset_x: arx + 150
								offset_y: ary + 300
							),
						...
						shape_style: {
							...
							'grey_blue':  draw.Shape{
								colors: draw.Colors{draw.rgb(127, 127, 127), draw.rgb(0,
									0, 127)}
							}
